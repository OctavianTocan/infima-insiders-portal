    ...
    <div className='form-content'>
      ...
      <div className='action-section'>
        <div className='github-btn-container'>
          <button className='github-btn' onClick={onLogin} title='Connect your GitHub account securely'>
      ...
      <div className='form-footer'>
        <button onClick={onBack} className='back-link' title='Go back to Discord connection'>
