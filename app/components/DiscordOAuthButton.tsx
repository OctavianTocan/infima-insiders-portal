...
// Base Discord Icon component for reuse
...
const DiscordLoadingButton: React.FC = () => (
  <button className="discord-btn discord-btn--loading" disabled>
    <DiscordIcon />
...
const DiscordAuthButton: React.FC = () => {
  ...
  return (
    <button onClick={handleDiscordAuth} className="discord-btn">
      <DiscordIcon />
...
const DiscordDisabledButton: React.FC = () => (
  <button className="discord-btn discord-btn--disabled" disabled>
    <DiscordIcon />
    <span>Sign in with Discord</span>
  </button>
);
...
const DiscordOAuthButton: React.FC = () => {
  ...
  const renderButton = () => {
    if (state.isLoading) {
      return <DiscordLoadingButton />;
    }
    
    if (state.verificationStatus === 'success') {
      return <DiscordDisabledButton />;
    }
  ...
  return (
    <div className="discord-oauth-container">
      {renderButton()}
      <p className="discord-oauth-help">
        We'll verify you're a member of the Infima Games Discord server with the "Verified" role.
      </p>
    </div>
  );
};
